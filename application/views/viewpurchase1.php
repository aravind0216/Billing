...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/datatables/datatables.min.css')?>"/>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        <button class="btn btn-success" onclick="add_customer()"><i class="glyphicon glyphicon-plus"></i> Add New Purchase</button>
...
<!-- End Bootstrap modal -->
  ...
  <div class="row">  
<form method="POST" action="<?php echo site_url('Viewpurchase1/datewise_report')?>" id="form">   
   <div class="col-sm-3">
        <h6>From Date:</h6>
        <div class="form-group">
...
<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <ul class="dropdown-menu">
      <li><a href="<?php echo base_url(); ?>Edit_purchase/fetch_purchase/<?php echo $row->p_id; ?>"> <i class="glyphicon glyphicon-edit"></i> Edit</a></li>
     
      <li><a type="button" onclick="payment_edit(<?php echo $row->p_id; ?>)"> <i class="glyphicon glyphicon-save"></i> Payment</a></li>

      <li><a target="_blank" href="<?php echo base_url(); ?>Purchase_print/fetch_print/<?php echo $row->p_id; ?>"> <i class="glyphicon glyphicon-print"></i> Print</a></li>
      <li><a type="button" id="removeOrderModalBtn" onclick="purchase_cancel(<?php echo $row->p_id; ?>)"> <i class="glyphicon glyphicon-trash"></i> Return</a></li>
...
function payment_edit(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('viewpurchase/edit_payment')?>/" + id,
        type: "POST",
        dataType: "JSON",
        success: function(data)
        {

            $('[name="id"]').val(data.p_id);
...
function purchase_cancel(id)
{
    if(confirm('Are you sure Cancel this Purchase?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('Purchase/purchase_cancel')?>/" + id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
$(".text-danger").remove();
    ...
    if(pay)
      {
      $.ajax({
            url : "<?php echo site_url('Viewpurchase/add_payment')?>",
            type: "POST",
            data: $('#form').serialize(),
            dataType: "JSON",
            success:function(data)
