...
<!--         <div><a href="mailto:company@example.com">company@example.com</a></div>
 -->      </div>
      <div id="project">
        <div><span>Purchase No</span> #<?php echo $row->p_id; ?></div>
        <div><span>Name</span> <?php echo $row->sname; ?></div>
        ...
        <div><span>DATE</span> <?php echo date('d-m-Y', strtotime($row->pdate)); ?></div>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="unit">₹<?php echo $row1->p_price; ?></td>
