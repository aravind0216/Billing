 ...
 <form action="#" id="form" class="form-horizontal">
 	<div class="row">
				...
				<h6>Company Name:</h6>
 				<div class="form-group">
 					<!-- <select onchange="getSupplierData()" id="cname1" class="cname1 form-control" name="cname1"></select> -->
              	   	<input value="<?php echo $row->cname; ?>" type="text" class="form-control" id="cname1" name="cname1" placeholder="Company Name">
              	   	<input value="<?php echo $row->cname; ?>" type="hidden" class="form-control" id="cname" name="cname" placeholder="Company Name">
					<input value="<?php echo $row->gstin; ?>" type="hidden" class="form-control" id="gstin" name="gstin" >
             	</div>
			</div>
			...
			<div class="col-sm-3">
				<h6>Supplier Name:</h6>
 				<div class="form-group">
              	   	<input value="<?php echo $row->sname; ?>" readonly="true" type="text" class="form-control" id="sname" name="sname" placeholder="Name">
             	</div>
			</div>
			<div class="col-sm-3">
				<h6>Mobile:</h6>
...
<table class="table table-striped table-bordered" cellspacing="0" width="100%" id="productTable">
						...
						?>
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">			  				
			  				<td style="padding-left:20px;">			  					<div class="form-group">
			  					...
			  					<input value="<?php echo $row1->pname; ?>" class="form-control" type="text" name="p_name1[]" id="p_name1<?php echo $x; ?>" autocomplete="off"  />	
			  				...
			  				<td style="padding-left:20px;">			  					
			  					<input value="<?php echo $row1->p_price; ?>" type="text" name="p_price<?php echo $x; ?>" id="p_price<?php echo $x; ?>" autocomplete="off" readonly="true" class="form-control" />			  					
		...
		<div class="row">
			 <div class="col-sm-3">
				<h6>Purchase Id:</h6>
 				<div class="form-group">
              	   	<input value="<?php echo $row->p_id; ?>" readonly="true" type="text" class="form-control" id="pid" name="pid" placeholder="ID">
             	</div>
			</div>
			...
			<div class="col-sm-3">
				<h6>Purchase Date:</h6>
 				<div class="form-group">
              	   	<input value="<?php echo date('d-m-Y', strtotime($row->pdate)); ?>" type="text" class="form-control" id="pdate" name="pdate" placeholder="Date">
             	</div>
			</div>
			<div class="col-sm-3">
				<h6>Due Date:</h6>
		...
		<div class="form-group submitButtonFooter">
			    <div class="col-sm-offset-2 col-sm-10">
			      ...
			      <a target="_blank" href="<?php echo base_url();?>Purchase_print/fetch_print/<?php echo $row->p_id; ?>"><button type="button" class="btn btn-default"><i class="glyphicon glyphicon-print"></i> Print</button></a>
			    </div>
		</div>
<?php }?>
</form>
	...
	if(tableLength > 0) {		
		...
		arrayNumber = 0;
			...
			var tr = '<tr id="row'+count+'" class="'+arrayNumber+'">'+				  				
				...
				'<input onkeyup="getProductData('+count+')" onclick="getProductData('+count+')" onchange="getProductData('+count+')" type="text" name="p_name1[]" id="p_name1'+count+'" autocomplete="off" class="form-control" />'+
...
{		
    ...
    $('.form-group').removeClass('has-error').removeClass('has-success');
			...
			$.ajax({
            url : "<?php echo site_url('Edit_purchase/update')?>",
            type: 'POST',
            data: $('#form').serialize(),
            dataType: 'JSON',
            success:function(data) 
