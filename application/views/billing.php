 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
  	 <section class="content-header">
        <button class="btn btn-success" onclick="viewbilling()"><i class="glyphicon glyphicon-plus"></i> View Billing</button>
 ...
 <form method="post" action="#" id="form" class="form-horizontal">
 	<div class="row">
			 ...
			 <div class="col-sm-2">
				<h6>Role:</h6>
 				<div class="form-group">
              	   	<input readonly="true" type="text" class="form-control" id="role" name="role" placeholder="Role">
             	</div>
			</div>
			<div class="col-sm-2">
				<h6>GSTIN:</h6>
 				<div class="form-group">
              	   	<input readonly="true" type="text" class="form-control" id="gstin" name="gstin" placeholder="GSTIN">
             	</div>
			</div>
			<div class="col-sm-2">
				<h6>Mobile:</h6>
...
<table class="table table-striped table-bordered" cellspacing="0" width="100%" id="productTable">
			  		...
			  		for($x = 1; $x <= 1; $x++) { ?>
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">			  				
			  				<td style="padding-left:20px;">			  					<div class="form-group">
			  					...
			  					<input class="form-control" onclick="getProductData(<?php echo $x; ?>)" onchange="getProductData(<?php echo $x; ?>)" type="text" name="p_name1[]" id="p_name1<?php echo $x; ?>" autocomplete="off"  />	
			  				...
			  				<td style="padding-left:20px;">
			  					<div class="form-group">
			  					<input type="text" name="qty<?php echo $x; ?>" id="qty<?php echo $x; ?>" onclick="getTotal(<?php echo $x ?>)" onchange="getTotal(<?php echo $x ?>)" autocomplete="off" class="form-control" min="1" />
			  					</div>
			  				</td>
			  				<td style="padding-left:20px;">			  					
		...
		<div class="row">
			...
			<div class="col-sm-2">
				<h6>Due Date:</h6>
 				<div class="form-group">
              	   	<input value="<?php echo date('d-m-Y', strtotime("+30 days")); ?>" type="text" class="form-control" id="duedate" name="duedate" placeholder="Due Date">
             	</div>
			</div>
			<div class="col-sm-3">
		...
		<div class="form-group submitButtonFooter">
			    <div class="col-sm-offset-2 col-sm-10">
			      ...
			      <a target="_blank" href="<?php echo base_url();?>Billing_print/fetch_print1"><button id="print" type="button" class="btn btn-default"><i class="glyphicon glyphicon-print"></i> Print</button></a>
			    </div>
		</div>
...
{		
    ...
    $('.form-group').removeClass('has-error').removeClass('has-success');
			...
			if(pdate && duedate && cname1 && advance && mode ) {
			...
			$.ajax({
            url : "<?php echo site_url('Billing/save1')?>",
            type: 'POST',
            data: $('#form').serialize(),
            dataType: 'JSON',
            success:function(data) 
